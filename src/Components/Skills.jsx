    ...
    return (
        <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                <div className=" border-blue-600 border-2 card w-80 bg-base-100 shadow-xl mx-auto">
                ...
                <div className=" border-blue-600 border-2 card w-80 bg-base-100 shadow-xl mx-auto">
                    <figure><img className="mt-8 w-2/5" src="../next_auth.png" alt="next auth" /></figure>
                    <div className="card-body">
                        <h2 className="text-xl font-medium text-center">Next Auth</h2>
                    </div>
                </div>
                <div className=" border-blue-600 border-2 card w-80 bg-base-100 shadow-xl mx-auto">
